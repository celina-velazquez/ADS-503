...
# Specifying multiple values of numbers of trees to create
ntree_values <- c(100, 250, 500, 1000)
...
A check for statistically significant differences in the RMSE values of each of the models reveals that there is a significant difference in RMSE between XGB and Ridge (p-value = 0.017) and between XGB and RF (p-value = 0.023). There was also a significant difference in the prediction error between Ridge and RF (p-value = 0.034). XGB achieved the lowest RMSE (2.384) and highest R-squared with a value of 0.925, and, as a result, was selected as the preferred model for prediction.
